...
# ================== LOAD DATA ==================
SHEET_PUBLISH_URL = "import streamlit as st
import pandas as pd
import folium
from streamlit_folium import st_folium
from datetime import datetime
...
# ================== LOAD DATA ==================
SHEET_PUBLISH_URL = "https://docs.google.com/spreadsheets/d/1727136443/pub?output=csv"  # ← CHANGE THIS
...
st.caption(f"Last updated: {datetime.now().strftime('%Y-%m-%d %H:%M')}")"  # ← CHANGE THIS
df = pd.read_csv(SHEET_PUBLISH_URL)
df = df.fillna("")
